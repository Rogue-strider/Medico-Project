...
//   document.title = "Medico | VitaminsAndSupplements ";
...
//         setsupplements((preState) => [...preState, ...data.results]);
//         setPage(page + 1);
//       } else {
//         setHasMore(false);
//       }
...
//           ></i>{" "}
//           VitaminsAndSupplements<small className="ml-2 text-sm bg-red-400 text-zinc-600">category</small>
//         </h1>
...
//       <InfiniteScroll
//         dataLength={supplements.length}
//         next={Getsupplements}
//         hasMore={hasMore}
//         loader={<h1>Loading...</h1>}
//       >
//         <Cards data={supplements} title="supplements" />
//       </InfiniteScroll>
//     </div>
//   ) : (
//     <Loading />
